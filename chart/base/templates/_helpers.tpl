...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "mq-quarkus-app.fullname" -}}
{{- if .Values.fullnameOverride -}}
{{- .Values.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
...
Common labels
*/}}
{{- define "mq-quarkus-app.labels" -}}
helm.sh/chart: {{ include "mq-quarkus-app.chart" . }}
{{ include "mq-quarkus-app.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "mq-quarkus-app.selectorLabels" -}}
app.kubernetes.io/name: {{ include "mq-quarkus-app.name" . }}
...
*/}}
{{- define "mq-quarkus-app.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "mq-quarkus-app.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
